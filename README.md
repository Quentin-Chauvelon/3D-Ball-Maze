...
The project is under development (started in December 2023). It is currently in a prototyping stage to validate the idea and making sure it could be fun to play.


# Project 

<details> 
<summary>Inspiration (click to see more)</summary>
...
I learnt C# by myself by working on the first version of the project in 2022 and by reading [Apprenez à développer en C#](https://www.fnac.com/a8267393/Nicolas-Hilaire-Apprenez-a-developper-en-c) written by Nicolas Hilaire.

As a solo developer on the project, I must work on all aspects of the game: coding, UI designing, modeling, testing, fixing bugs... which will allow me to learn and improve a lot on all those aspects.  
